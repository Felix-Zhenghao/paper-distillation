...
- **FLIP**: Flow-Centric Generative Planning for General-Purpose Manipulation Tasks [[arxiv](https://arxiv.org/abs/2412.08261)][[website](https://nus-lins-lab.github.io/flipweb/)]. 2-D grid on a video. The gradient of 2-D grid as high-level plan. LiV to do select planned trajectories.
